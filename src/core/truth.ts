...
export class CommerceTruthEngine {
  ...
  public seedDefaultCatalog(): void {
    ...
    const defaultItems: CatalogItem[] = [
      ...
      },
      {
        ...
        category: "electronics",
        unit_price: 152458, // INR 1,524.58
        tax_rate_bps: 1800, // 18% GST (INR 274.42 -> Total INR 1,799.00)
        available_stock: 10,
        is_active: true,
      },
      {
      ...
      },
      {
        ...
        category: "electronics",
        unit_price: 76186, // INR 761.86
        tax_rate_bps: 1800, // 18% GST (INR 137.14 -> Total INR 899.00)
        available_stock: 15,
        is_active: true,
      },
      {
        ...
        category: "electronics",
        unit_price: 127119, // INR 1,271.19
        tax_rate_bps: 1800, // 18% GST (INR 228.81 -> Total INR 1,500.00)
        available_stock: 8,
        is_active: true,
      },
      {
   ...
   */
  public resolveTruth(proposedItems: ProposedItem[]): TruthResolutionResult {
    const resolved = [];
    let grandTotal = 0;
    let grandTax = 0;
